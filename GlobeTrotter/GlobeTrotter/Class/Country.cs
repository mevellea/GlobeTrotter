...
namespace GlobeTrotter
{
    public class Country
    {
        ...
        public struct PointUnit
        {
            public int IndexStart;
            public int IndexStop;
        }

        private List<PointUnit> _pointsList = new List<PointUnit>();

        private Boolean _stopInProgress;
        private Boolean _newInProgress;
        private Boolean _intermediateInProgress;
        private PointUnit _pointNew;
        private PointUnit _pointIntermediate;

        public String Name;
        public List<List<PointUnit>> PointsBlock;
        public int Color;
        public String Code;
        ...
        {
            Name = _name;
            PointsBlock = new List<List<PointUnit>>();
            Color = 0;
            Code = _code;
        }
